...
const NetIncomeResult: React.FC<Props> = ({ netIncome, incomeTax, ssnit, tier2 }) => (
  <div className="w-full flex flex-col items-center gap-1">
    <div className="text-center text-sm font-medium text-purple-700">Net Income (take home after SSNIT and tax)</div>
    ...
    <div className="flex flex-row justify-center gap-8 mt-2">
      ...
      {tier2 !== undefined && (
        <div className="text-xs text-gray-500 flex flex-col items-center">
          <span>
            Pension (Tier 2, 5%)
            <span className="block text-[10px] leading-tight text-gray-400">(not deducted from take home)</span>
          </span>
